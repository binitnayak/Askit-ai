...
//       alert(
//         "Cannot connect to AskIt backend."
//       );
//     }
//   };
...
//     try {
//       const response = await fetch(
//         `${API_URL}/conversations/${id}/rename`,
//         {
//           method: "PUT",
...
//       // If currently open conversation was deleted
...
//     if (!sourceLoaded) {
//       alert(
//         "Please load a YouTube video or document first."
//       );
...
//     ) {
//       alert(
//         "Conversation not found. Please create a new chat and load a source."
//       );
...
//       // title/updated_at may have changed
//       await loadConversations();
//     } catch (error) {
//       console.error(
//         "Chat error:",
